            ...
            <div class="hamburgerContainer">
                ...
                <div class="navigation">
                    <ul class="navigation__list">
                        <li class="navigation__item"><a href="public/views/start.html">HOME</a></li>
                        <li class="navigation__item"><a href="public/views/welcome.html">ABOUT US</a></li>
                        <li class="navigation__item"><a href="public/views/recipe.html">RECIPE</a></li>
                        <li class="navigation__item"><a href="public/views/team.html">TEAM</a></li>
                        <li class=" navigation__item"><a href="public/views/contact.html">CONTACT</a></li>
                        ...
                        <li class="navigation__item"><a href="public/views/login.html">Log Out</a></li>

                    </ul>
                </div>
            </div>
            <ul class="list">
                <li class="listItem"><a href="public/views/start.html" class="listLink">Home</a></li>
                <li class="listItem"><a href="public/views/welcome.html" class="listLink">About Us</a></li>
                <li class="listItem"><a href="public/views/recipe.html" class="listLink">Recipe</a></li>
                <li class="listItem"><a href="public/views/team.html" class="listLink">Team</a></li>
                <li class="listItem"><a href="public/views/contact.html" class="listLink">Contact</a></li>
            </ul>
