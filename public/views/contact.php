...
<body>
    <main class="main">
        <nav class="nav">
            ...
            <div class="hamburgerContainer">
                ...
                <div class="navigation">
                    <ul class="navigation__list">
                        <li class="navigation__item"><a href="../views/start.php">HOME</a></li>
            ...
            <ul class="list">
                <li class="listItem"><a href="../views/start.php" class="listLink">Home</a></li>
            ...
            <section class="iconContainer">
                ...
                <a href="https://www.instagram.com/" target="_blank"><img src="../img/nav icon/ig.svg"
                        alt="instagram icon" class="icon"></a>
                <li class="navigation__item"><a href="login.php" class="logOutLink">Log Out</a></li>
        </nav>
        <section class="contactSection">
            <a href="mailto:mail.nawrocki@o2.pl" class="linkContant"><img src="../img/email.svg" alt="mail"
                    class="mail">
                <p class="contact">mail.nawrocki@o2.pl</p>
            </a>
            <a href="tel:+1111111111" class="linkContant"><img src="../img/phone.svg" alt="phone" class="phone">
                <p>
                    +48 111111111
                </p>
            </a>
