        ...
        <div class="section__recipes">
            <?php foreach ($recipe as $recipes): ?>
                <div class="section__recipe">
                    <img src="public/uploads/<?= $recipes-> getImage(); ?>" alt="scrambled eggs"
                                                  class="section__recipeImage">
                    <div class="section__info">
                        <p class="section__recipeName"><?= $recipes-> getTitle(); ?></p>
                        <p class="section__recipeDescription"><?= $recipes-> getDescription(); ?></p>
                        <p class="section__recipeName"><?= $recipes-> getKcal(); ?> kcal</p>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
